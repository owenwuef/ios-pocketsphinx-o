...
- (void)testThatRunRecognitionOnWavFileAtPathWorks {
    ...
    NSError *error = [_languageModelGenerator generateGrammarFromDictionary:@{OneOfTheseWillBeSaidOnce:lmArray}  withFilesNamed:@"WordLanguageModel" forAcousticModelAtPath:[[OETestTools environmentAppropriateBundle] pathForResource:@"AcousticModelEnglish" ofType:@"bundle"]];
